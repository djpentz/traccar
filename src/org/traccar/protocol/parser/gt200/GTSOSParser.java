...
/**
 * This parses the GTSOS command, logs it, and triggers an alert.
 *
 * @author djpentz
 * @since 2014/06/29 12:54 PM
 */
public class GTSOSParser extends QueclinkParser {
     ...
     * +RESP:GTSOS,865017010019238,0,0,0,1,0.0,0,53.4,1,18.864207,-34.079603,20140629105353,0655,0001,00DD,5CAA,00,0007,0102030304
